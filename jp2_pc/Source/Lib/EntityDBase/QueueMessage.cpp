...
//
	...
	#else
		pdqwmCurrentMessages = new std::queue< std::deque<std::shared_ptr<CMessage>> >();   //lint !e1732 !e1733
		pdqwmNextMessages    = new std::queue< std::deque<std::shared_ptr<CMessage>> >();	//lint !e1732 !e1733
	#endif
